...
List<TodoObject> todos = [
  ...
  new TodoObject.import(
      "SOME_RANDOM_UUID", "Custom", 1, ColorChoies.colors[0], Icons.alarm, {
  ...
  new TodoObject.import(
      "SOME_RANDOM_UUID2", "Persion", 1, ColorChoies.colors[1], Icons.person, {
  ...
  new TodoObject.import(
      "SOME_RANDOM_UUID3", "Work", 1, ColorChoies.colors[2], Icons.work, {
    new DateTime(2018, 5, 3): [
      new TaskObject("Meet Clients", new DateTime(2018, 5, 3)),
      new TaskObject("Design Sprint", new DateTime(2018, 5, 3)),
      new TaskObject("Icon Set Design for Mobile", new DateTime(2018, 5, 3)),
...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    colorTween = new ColorTween(
        begin: ColorChoies.colors[0], end: ColorChoies.colors[1]);
                      ...
                      new Container(
                        ...
                        child: new Column(
                          ...
                          children: <Widget>[
                            ...
                            new Text(
                              "You have ${getTodoCount()} tasks to do today.",
                              style: new TextStyle(color: Colors.white70),
                            ),
                          ],
                        ),
